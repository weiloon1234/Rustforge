...
fn render_admin_type_enum() -> String {
    ...
    let variants = AdminType::variants();
    let mut out = enum_to_ts_type("AdminType", variants);
    ...
    for variant in variants {
        ...
        out.push_str(&format!(
            "\n  {}: {},",
            ts_const_key(value),
            serde_json::to_string(&value).expect("admin type value"),
        ));
    }
    out.push_str("\n};");
    ...
    for variant in variants {
        ...
        out.push_str(&format!(
            "\n  {},",
            serde_json::to_string(&value).expect("admin type list value"),
        ));
    }
    out.push_str("\n];");
