...
async fn review_deposit(
    ...
    Ok(ApiResponse::success(
        DepositOutput {
            ...
            conversion_rate: deposit.conversion_rate.map(Into::into),
            status: deposit.status,
            amount: deposit.amount.into(),
            fee: deposit.fee.into(),
            net_amount: deposit.net_amount.into(),
            related_key: deposit.related_key.clone(),
            remark: deposit.remark.clone(),
            admin_remark: deposit.admin_remark.clone(),
            reviewed_at: deposit.reviewed_at.map(Into::into),
