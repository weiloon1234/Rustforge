...
async fn review_withdrawal(
    ...
    Ok(ApiResponse::success(
        WithdrawalOutput {
            ...
            related_key: withdrawal.related_key,
            remark: withdrawal.remark,
            admin_remark: withdrawal.admin_remark,
...
async fn upload_receipt(
    ...
    generated::models::Withdrawal::new(core_db::common::sql::DbConn::pool(&state.db), None)
        .update()
        .where_id(core_db::common::sql::Op::Eq, id)
        .set_params(Some(params.clone()))
        .save()
        .await
        .map_err(AppError::from)?;
