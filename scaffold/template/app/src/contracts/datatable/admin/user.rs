        ...
        vec![
            ...
            vec![
                ...
                DataTableFilterFieldDto {
                    ...
                    filter_key: "f-like-contact_number".to_string(),
                    field_type: DataTableFilterFieldType::ContactInput,
                    label: "Contact Number".to_string(),
                    placeholder: None,
                    description: None,
                    secondary_filter_key: Some("f-eq-contact_country_iso2".to_string()),
                    options: None,
                },
            ],
            vec![
