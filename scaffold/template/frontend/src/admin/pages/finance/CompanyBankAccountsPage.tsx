...
export default function CompanyBankAccountsPage() {
  ...
  const canManage = useAuthStore.getState().hasPermission(PERMISSION.COMPANY_BANK_ACCOUNT_MANAGE, account);
      ...
      columns={[
        ...(canManage
          ? [{
              ...
              label: t("Actions"),
              sortable: false,
              render: (row: CompanyBankAccountDatatableRow, _: number, refresh: () => void) => (
