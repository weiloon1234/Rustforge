...
export type AdminType = "developer" | "superadmin" | "admin" | "Developer" | "SuperAdmin" | "Admin" | "developer" | "superadmin" | "admin" | "enum.admin_type.developer" | "enum.admin_type.super_admin" | "enum.admin_type.admin";
...
export const ADMIN_TYPE: Readonly<Record<string, AdminType>> = {
  ...
  SUPERADMIN: "superadmin",
  ADMIN: "admin",
  ENUM_ADMIN_TYPE_DEVELOPER: "enum.admin_type.developer",
  ENUM_ADMIN_TYPE_SUPER_ADMIN: "enum.admin_type.super_admin",
  ENUM_ADMIN_TYPE_ADMIN: "enum.admin_type.admin",
};
...
export const ADMIN_TYPES: ReadonlyArray<AdminType> = [
  ...
  "superadmin",
  "admin",
  "enum.admin_type.developer",
  "enum.admin_type.super_admin",
  "enum.admin_type.admin",
];

export type AuthClientType = "web" | "mobile";

export type ContentPageSystemFlag = "0" | "1" | "No" | "Yes" | "enum.content_page_system_flag.no" | "enum.content_page_system_flag.yes";
...
export const CONTENT_PAGE_SYSTEM_FLAG: Readonly<Record<string, ContentPageSystemFlag>> = {
  ...
  NO: "No",
  YES: "Yes",
  ENUM_CONTENT_PAGE_SYSTEM_FLAG_NO: "enum.content_page_system_flag.no",
  ENUM_CONTENT_PAGE_SYSTEM_FLAG_YES: "enum.content_page_system_flag.yes",
};
...
export const CONTENT_PAGE_SYSTEM_FLAGS: ReadonlyArray<ContentPageSystemFlag> = [
  ...
  "No",
  "Yes",
  "enum.content_page_system_flag.no",
  "enum.content_page_system_flag.yes",
];
