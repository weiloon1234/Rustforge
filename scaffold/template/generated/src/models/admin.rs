...
pub async fn get_as<T>(self) -> Result<Vec<T>>
    ...
    pub async fn sum(self, col: AdminDbCol) -> Result<Option<f64>> {
        ...
        record_profiled_query("admin", "SUM", &sql, &__profiler_binds, __profiler_start.elapsed());
        Ok(result)
    }
    ...
    pub async fn avg(self, col: AdminDbCol) -> Result<Option<f64>> {
        ...
        for b in join_binds { q = bind_scalar(q, b); }
        let result = db.fetch_scalar(q).await?;
        record_profiled_query("admin", "AVG", &sql, &__profiler_binds, __profiler_start.elapsed());
        Ok(result)
    }
    ...
    pub async fn min_val(self, col: AdminDbCol) -> Result<Option<i64>> {
        ...
        for b in join_binds { q = bind_scalar(q, b); }
        let result = db.fetch_scalar(q).await?;
        record_profiled_query("admin", "MIN_VAL", &sql, &__profiler_binds, __profiler_start.elapsed());
        Ok(result)
    }
    ...
    pub async fn max_val(self, col: AdminDbCol) -> Result<Option<i64>> {
        ...
        for b in join_binds { q = bind_scalar(q, b); }
        let result = db.fetch_scalar(q).await?;
        record_profiled_query("admin", "MAX_VAL", &sql, &__profiler_binds, __profiler_start.elapsed());
        Ok(result)
    }
