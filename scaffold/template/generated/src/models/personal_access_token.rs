...
impl PersonalAccessTokenView {
    pub fn update<'db>(&self, db: impl Into<DbConn<'db>>) -> PersonalAccessTokenUpdate<'db> {
        PersonalAccessToken::new(db.into(), None)
            .update()
            .where_id(Op::Eq, self.id.clone())
    }
    pub fn update_with<'db>(
        &self,
        model: &PersonalAccessToken<'db>,
    ) -> PersonalAccessTokenUpdate<'db> {
...
pub trait PersonalAccessTokenViewsExt {
    ...
    fn key_by<K>(
        &self,
        f: impl Fn(&PersonalAccessTokenView) -> K,
    ) -> std::collections::HashMap<K, PersonalAccessTokenView>
    where
        K: Eq + std::hash::Hash;
    fn group_by<K>(
        &self,
        f: impl Fn(&PersonalAccessTokenView) -> K,
    ) -> std::collections::HashMap<K, Vec<PersonalAccessTokenView>>
    where
        K: Eq + std::hash::Hash;
}
...
impl<'db> PersonalAccessToken<'db> {
    ...
    pub fn query(&self) -> PersonalAccessTokenQuery<'db> {
        PersonalAccessTokenQuery::new(self.db.clone(), self.base_url.clone())
    }
    pub fn insert(&self) -> PersonalAccessTokenInsert<'db> {
        PersonalAccessTokenInsert::new(self.db.clone(), self.base_url.clone())
    }
    pub fn update(&self) -> PersonalAccessTokenUpdate<'db> {
        PersonalAccessTokenUpdate::new(self.db.clone(), self.base_url.clone())
    }
...
impl<'db> PersonalAccessTokenQuery<'db> {
    ...
    pub fn unsafe_sql(self) -> PersonalAccessTokenUnsafeQuery<'db> {
        PersonalAccessTokenUnsafeQuery::new(self)
    }
    pub fn where_id(mut self, op: Op, val: uuid::Uuid) -> Self {
        let idx = self.binds.len() + 1;
        self.where_sql.push(format!(
            "{} {} ${}",
            PersonalAccessTokenCol::Id.as_sql(),
            op.as_sql(),
            idx
        ));
    ...
    pub fn where_tokenable_type(mut self, op: Op, val: String) -> Self {
        ...
        self.where_sql.push(format!(
            "{} {} ${}",
            PersonalAccessTokenCol::TokenableType.as_sql(),
            op.as_sql(),
            idx
        ));
        self.binds.push(val.into());
    ...
    pub fn where_tokenable_id(mut self, op: Op, val: String) -> Self {
        ...
        self.where_sql.push(format!(
            "{} {} ${}",
            PersonalAccessTokenCol::TokenableId.as_sql(),
            op.as_sql(),
            idx
        ));
        self.binds.push(val.into());
    ...
    pub fn where_name(mut self, op: Op, val: String) -> Self {
        ...
        self.where_sql.push(format!(
            "{} {} ${}",
            PersonalAccessTokenCol::Name.as_sql(),
            op.as_sql(),
            idx
        ));
        self.binds.push(val.into());
    ...
    pub fn where_token(mut self, op: Op, val: String) -> Self {
        ...
        self.where_sql.push(format!(
            "{} {} ${}",
            PersonalAccessTokenCol::Token.as_sql(),
            op.as_sql(),
            idx
        ));
        self.binds.push(val.into());
    ...
    pub fn where_token_kind(mut self, op: Op, val: PersonalAccessTokenKind) -> Self {
        ...
        self.where_sql.push(format!(
            "{} {} ${}",
            PersonalAccessTokenCol::TokenKind.as_sql(),
            op.as_sql(),
            idx
        ));
        self.binds.push(val.into());
    ...
    pub fn where_family_id(mut self, op: Op, val: uuid::Uuid) -> Self {
        ...
        self.where_sql.push(format!(
            "{} {} ${}",
            PersonalAccessTokenCol::FamilyId.as_sql(),
            op.as_sql(),
            idx
        ));
        self.binds.push(val.into());
    ...
    pub fn where_parent_token_id(mut self, op: Op, val: Option<uuid::Uuid>) -> Self {
        ...
        self.where_sql.push(format!(
            "{} {} ${}",
            PersonalAccessTokenCol::ParentTokenId.as_sql(),
            op.as_sql(),
            idx
        ));
        self.binds.push(val.into());
    ...
    pub fn where_abilities(mut self, op: Op, val: Option<serde_json::Value>) -> Self {
        ...
        self.where_sql.push(format!(
            "{} {} ${}",
            PersonalAccessTokenCol::Abilities.as_sql(),
            op.as_sql(),
            idx
        ));
        self.binds.push(val.into());
    ...
    pub fn where_last_used_at(mut self, op: Op, val: Option<time::OffsetDateTime>) -> Self {
        ...
        self.where_sql.push(format!(
            "{} {} ${}",
            PersonalAccessTokenCol::LastUsedAt.as_sql(),
            op.as_sql(),
            idx
        ));
        self.binds.push(val.into());
    ...
    pub fn where_expires_at(mut self, op: Op, val: Option<time::OffsetDateTime>) -> Self {
        ...
        self.where_sql.push(format!(
            "{} {} ${}",
            PersonalAccessTokenCol::ExpiresAt.as_sql(),
            op.as_sql(),
            idx
        ));
        self.binds.push(val.into());
    ...
    pub fn where_revoked_at(mut self, op: Op, val: Option<time::OffsetDateTime>) -> Self {
        ...
        self.where_sql.push(format!(
            "{} {} ${}",
            PersonalAccessTokenCol::RevokedAt.as_sql(),
            op.as_sql(),
            idx
        ));
        self.binds.push(val.into());
    ...
    pub fn where_created_at(mut self, op: Op, val: time::OffsetDateTime) -> Self {
        ...
        self.where_sql.push(format!(
            "{} {} ${}",
            PersonalAccessTokenCol::CreatedAt.as_sql(),
            op.as_sql(),
            idx
        ));
        self.binds.push(val.into());
    ...
    pub fn where_updated_at(mut self, op: Op, val: time::OffsetDateTime) -> Self {
        ...
        self.where_sql.push(format!(
            "{} {} ${}",
            PersonalAccessTokenCol::UpdatedAt.as_sql(),
            op.as_sql(),
            idx
        ));
        self.binds.push(val.into());
    ...
    pub fn where_key_in<T: Clone + Into<BindValue>>(self, vals: &[T]) -> Self {
        self.where_in(PersonalAccessTokenCol::Id, vals)
    }
    pub fn where_col<T: Into<BindValue>>(
        mut self,
        col: PersonalAccessTokenCol,
        op: Op,
        val: T,
    ) -> Self {
        let idx = self.binds.len() + 1;
    ...
    pub async fn first_or_fail(self) -> Result<PersonalAccessTokenView> {
        self.first()
            .await?
            .ok_or_else(|| anyhow::anyhow!("personal_access_tokens: record not found"))
    }
    ...
    pub async fn first_or_create(
        self,
        create: impl FnOnce(PersonalAccessTokenInsert<'db>) -> PersonalAccessTokenInsert<'db>,
    ...
    pub async fn update_or_create(
        ...
        if let Some(existing) = self.first().await? {
            ...
            return PersonalAccessToken::new(db, base_url.clone())
                .query()
                .find(existing.id)
                .await
                .map(|r| r.unwrap());
    ...
    pub async fn pluck_pair<K, V>(
        self,
        extract: impl Fn(&PersonalAccessTokenView) -> (K, V),
...
impl<'db> PersonalAccessTokenUnsafeQuery<'db> {
    fn new(inner: PersonalAccessTokenQuery<'db>) -> Self {
        Self { inner }
    }
    ...
    pub fn done(self) -> PersonalAccessTokenQuery<'db> {
        self.inner
    }
}
...
impl<'db> PersonalAccessTokenInsert<'db> {
    ...
    async fn save_with_db<'tx>(self, db: DbConn<'tx>) -> Result<PersonalAccessTokenView> {
        ...
        if HAS_CREATED_AT
            && !cols
                .iter()
                .any(|c| matches!(c, PersonalAccessTokenCol::CreatedAt))
        {
        ...
        if HAS_UPDATED_AT
            && !cols
                .iter()
                .any(|c| matches!(c, PersonalAccessTokenCol::UpdatedAt))
        {
            let now = time::OffsetDateTime::now_utc();
...
impl<'db> PersonalAccessTokenUpdate<'db> {
    ...
    pub fn unsafe_sql(self) -> PersonalAccessTokenUnsafeUpdate<'db> {
        PersonalAccessTokenUnsafeUpdate::new(self)
    }
    pub fn set_id(mut self, val: uuid::Uuid) -> Self {
    ...
    pub fn set_tokenable_type(mut self, val: String) -> Self {
        self.sets
            .push((PersonalAccessTokenCol::TokenableType, val.into()));
        self
    }
    pub fn set_tokenable_id(mut self, val: String) -> Self {
        self.sets
            .push((PersonalAccessTokenCol::TokenableId, val.into()));
        self
    }
    pub fn set_name(mut self, val: String) -> Self {
    ...
    pub fn set_token_kind(mut self, val: PersonalAccessTokenKind) -> Self {
        self.sets
            .push((PersonalAccessTokenCol::TokenKind, val.into()));
        self
    }
    pub fn set_family_id(mut self, val: uuid::Uuid) -> Self {
        self.sets
            .push((PersonalAccessTokenCol::FamilyId, val.into()));
        self
    }
    pub fn set_parent_token_id(mut self, val: Option<uuid::Uuid>) -> Self {
        self.sets
            .push((PersonalAccessTokenCol::ParentTokenId, val.into()));
        self
    }
    pub fn set_abilities(mut self, val: Option<serde_json::Value>) -> Self {
        self.sets
            .push((PersonalAccessTokenCol::Abilities, val.into()));
        self
    }
    pub fn set_last_used_at(mut self, val: Option<time::OffsetDateTime>) -> Self {
        self.sets
            .push((PersonalAccessTokenCol::LastUsedAt, val.into()));
        self
    }
    pub fn set_expires_at(mut self, val: Option<time::OffsetDateTime>) -> Self {
        self.sets
            .push((PersonalAccessTokenCol::ExpiresAt, val.into()));
        self
    }
    pub fn set_revoked_at(mut self, val: Option<time::OffsetDateTime>) -> Self {
        self.sets
            .push((PersonalAccessTokenCol::RevokedAt, val.into()));
        self
    }
    pub fn set_created_at(mut self, val: time::OffsetDateTime) -> Self {
        self.sets
            .push((PersonalAccessTokenCol::CreatedAt, val.into()));
        self
    }
    pub fn set_updated_at(mut self, val: time::OffsetDateTime) -> Self {
        self.sets
            .push((PersonalAccessTokenCol::UpdatedAt, val.into()));
        self
    }
    pub fn where_id(mut self, op: Op, val: uuid::Uuid) -> Self {
        let idx = self.binds.len() + 1;
    ...
    async fn save_with_db<'tx>(self, db: DbConn<'tx>) -> Result<u64> {
        ...
        let select_sql = format!(
            "SELECT id FROM personal_access_tokens WHERE {}",
...
impl<'db> PersonalAccessTokenUnsafeUpdate<'db> {
    fn new(inner: PersonalAccessTokenUpdate<'db>) -> Self {
        Self { inner }
    }
    pub fn where_raw(mut self, clause: RawClause) -> Self {
        let (sql, binds) = clause.into_parts();
    ...
    pub fn done(self) -> PersonalAccessTokenUpdate<'db> {
        self.inner
    }
}
...
impl GeneratedTableAdapter for PersonalAccessTokenTableAdapter {
    ...
    fn column_descriptors(&self) -> &'static [DataTableColumnDescriptor] {
        &[
            ...
            DataTableColumnDescriptor {
                name: "token_kind",
                label: "Token Kind",
                data_type: "PersonalAccessTokenKind",
                sortable: true,
                localized: false,
                filter_ops: &["eq", "gte", "lte"],
            },
            ...
            DataTableColumnDescriptor {
                name: "last_used_at",
                label: "Last Used At",
                data_type: "Option<time::OffsetDateTime>",
                sortable: true,
                localized: false,
    ...
    fn apply_auto_filter<'db>(
        &self,
        query: PersonalAccessTokenQuery<'db>,
        filter: &ParsedFilter,
        value: &str,
    ) -> anyhow::Result<Option<PersonalAccessTokenQuery<'db>>>
    where
        Self: 'db,
    {
    ...
    fn apply_sort<'db>(
        ...
        column: &str,
        dir: SortDirection,
    ) -> anyhow::Result<PersonalAccessTokenQuery<'db>>
    where
        Self: 'db,
    {
        let dir = match dir {
    ...
    fn cursor_from_row(&self, row: &PersonalAccessTokenView, column: &str) -> Option<String> {
        match column {
            ...
            "last_used_at" => row.last_used_at.as_ref().and_then(|v| {
                v.format(&time::format_description::well_known::Rfc3339)
                    .ok()
            }),
            "expires_at" => row.expires_at.as_ref().and_then(|v| {
                v.format(&time::format_description::well_known::Rfc3339)
                    .ok()
            }),
            "revoked_at" => row.revoked_at.as_ref().and_then(|v| {
                v.format(&time::format_description::well_known::Rfc3339)
                    .ok()
            }),
            "created_at" => row
    ...
    fn count<'db>(
        &self,
        query: PersonalAccessTokenQuery<'db>,
    ) -> BoxFuture<'db, anyhow::Result<i64>>
    where
        Self: 'db,
    {
    ...
    fn fetch_page<'db>(
        ...
        page: i64,
        per_page: i64,
    ) -> BoxFuture<'db, anyhow::Result<Vec<PersonalAccessTokenView>>>
    where
        Self: 'db,
    {
...
pub trait PersonalAccessTokenDataTableHooks: Send + Sync + 'static {
    ...
    fn filter_query<'db>(
        &'db self,
        _query: PersonalAccessTokenQuery<'db>,
        _filter_key: &str,
        _value: &str,
        _input: &DataTableInput,
        _ctx: &DataTableContext,
    ...
    fn map_row(
        &self,
        _row: &mut PersonalAccessTokenView,
        _input: &DataTableInput,
        _ctx: &DataTableContext,
    ) -> anyhow::Result<()> {
        Ok(())
...
pub struct PersonalAccessTokenDataTable<H = PersonalAccessTokenDefaultDataTableHooks>
where
    H: PersonalAccessTokenDataTableHooks,
{
    pub db: sqlx::PgPool,
    pub hooks: H,
...
impl<H: PersonalAccessTokenDataTableHooks> PersonalAccessTokenDataTable<H> {
    pub fn with_hooks<NH: PersonalAccessTokenDataTableHooks>(
        self,
        hooks: NH,
    ) -> PersonalAccessTokenDataTable<NH> {
...
impl<H: PersonalAccessTokenDataTableHooks> AutoDataTable for PersonalAccessTokenDataTable<H> {
    ...
    fn base_query<'db>(
        ...
        self.hooks
            .scope(PersonalAccessToken::new(&self.db, None).query(), input, ctx)
    }
    ...
    fn map_row(
        &self,
        row: &mut PersonalAccessTokenView,
        input: &DataTableInput,
        ctx: &DataTableContext,
    ) -> anyhow::Result<()> {
