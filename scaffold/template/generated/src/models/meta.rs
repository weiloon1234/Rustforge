...
impl MetaModel {
    ...
    pub async fn find<'db>(db: impl Into<DbConn<'db>>, id: i64) -> Result<Option<MetaRecord>> {
        MetaQueryInner::new(db.into(), None).find(id).await
    }
}
...
impl core_db::common::model_api::PatchModel for MetaModel {
    ...
    fn patch_from_query<'db>(mut query: Self::InnerQuery<'db>) -> Self::InnerPatch<'db> {
        ...
        query.select_sql = Some(MetaDbCol::Id.as_sql().to_string());
...
impl core_db::common::model_api::QueryField<MetaModel> for MetaDbCol {
    type Value = BindValue;
    fn where_col<'db>(field: Self, query: <MetaModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>, op: Op, value: <Self as core_db::common::model_api::QueryField<MetaModel>>::Value) -> <MetaModel as core_db::common::model_api::QueryModel>::InnerQuery<'db> {
        query.where_col(field, op, value)
    }
    fn or_where_col<'db>(field: Self, query: <MetaModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>, op: Op, value: <Self as core_db::common::model_api::QueryField<MetaModel>>::Value) -> <MetaModel as core_db::common::model_api::QueryModel>::InnerQuery<'db> {
        query.or_where_col(field, op, value)
    }
    fn where_in<'db>(field: Self, query: <MetaModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>, values: &[<Self as core_db::common::model_api::QueryField<MetaModel>>::Value]) -> <MetaModel as core_db::common::model_api::QueryModel>::InnerQuery<'db> {
        query.where_in(field, values)
    }
    fn order_by<'db>(field: Self, query: <MetaModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>, dir: OrderDir) -> <MetaModel as core_db::common::model_api::QueryModel>::InnerQuery<'db> {
        query.order_by(field, dir)
    }
    fn where_null<'db>(field: Self, query: <MetaModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>) -> <MetaModel as core_db::common::model_api::QueryModel>::InnerQuery<'db> {
        query.where_null(field)
    }
    fn where_not_null<'db>(field: Self, query: <MetaModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>) -> <MetaModel as core_db::common::model_api::QueryModel>::InnerQuery<'db> {
...
{
    type Value = T;
    fn where_col<'db>(field: Self, query: <MetaModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>, op: Op, value: Self::Value) -> <MetaModel as core_db::common::model_api::QueryModel>::InnerQuery<'db> {
    ...
    fn or_where_col<'db>(field: Self, query: <MetaModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>, op: Op, value: Self::Value) -> <MetaModel as core_db::common::model_api::QueryModel>::InnerQuery<'db> {
        let col = resolve_meta_db_col(field.as_sql()).expect("typed generated column must resolve to an internal db column");
        query.or_where_col(col, op, value)
    }
    fn where_in<'db>(field: Self, query: <MetaModel as core_db::common::model_api::QueryModel>::InnerQuery<'db>, values: &[Self::Value]) -> <MetaModel as core_db::common::model_api::QueryModel>::InnerQuery<'db> {
        let col = resolve_meta_db_col(field.as_sql()).expect("typed generated column must resolve to an internal db column");
