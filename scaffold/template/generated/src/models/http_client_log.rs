...
pub async fn get_as<T>(self) -> Result<Vec<T>>
    ...
    pub async fn sum(self, col: HttpClientLogCol) -> Result<Option<f64>> {
        ...
        record_profiled_query("http_client_logs", "SUM", &sql, &__profiler_binds, __profiler_start.elapsed());
        Ok(result)
    }
    ...
    pub async fn avg(self, col: HttpClientLogCol) -> Result<Option<f64>> {
        ...
        for b in join_binds { q = bind_scalar(q, b); }
        let result = db.fetch_scalar(q).await?;
        record_profiled_query("http_client_logs", "AVG", &sql, &__profiler_binds, __profiler_start.elapsed());
        Ok(result)
    }
    ...
    pub async fn min_val(self, col: HttpClientLogCol) -> Result<Option<i64>> {
        ...
        for b in join_binds { q = bind_scalar(q, b); }
        let result = db.fetch_scalar(q).await?;
        record_profiled_query("http_client_logs", "MIN_VAL", &sql, &__profiler_binds, __profiler_start.elapsed());
        Ok(result)
    }
    ...
    pub async fn max_val(self, col: HttpClientLogCol) -> Result<Option<i64>> {
        ...
        for b in join_binds { q = bind_scalar(q, b); }
        let result = db.fetch_scalar(q).await?;
        record_profiled_query("http_client_logs", "MAX_VAL", &sql, &__profiler_binds, __profiler_start.elapsed());
        Ok(result)
    }
