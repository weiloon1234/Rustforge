...
impl HttpClientLogView {
    pub fn update<'db>(&self, db: impl Into<DbConn<'db>>) -> HttpClientLogUpdate<'db> {
        HttpClientLog::new(db.into(), None).update().where_id(Op::Eq, self.id)
    }
...
fn hydrate_view(row: HttpClientLogRow, loc: &LocalizedMap, base_url: Option<&str>) -> HttpClientLogView {
...
impl HttpClientLogCol {
    pub const fn all() -> &'static [HttpClientLogCol] {
        &[HttpClientLogCol::Id, HttpClientLogCol::RequestUrl, HttpClientLogCol::RequestMethod, HttpClientLogCol::ResponseStatus, HttpClientLogCol::DurationMs, HttpClientLogCol::RequestHeaders, HttpClientLogCol::RequestBody, HttpClientLogCol::ResponseHeaders, HttpClientLogCol::ResponseBody, HttpClientLogCol::CreatedAt]
    }
...
impl<'db> HttpClientLogQuery<'db> {
    ...
    pub async fn first_or_create(self, create: impl FnOnce(HttpClientLogInsert<'db>) -> HttpClientLogInsert<'db>) -> Result<HttpClientLogView> {
    ...
    pub async fn update_or_create(
        ...
        if let Some(existing) = self.first().await? {
            ...
            return HttpClientLog::new(db, base_url.clone()).query().find(existing.id).await.map(|r| r.unwrap());
        }
    ...
    pub async fn increment(self, col: HttpClientLogCol, amount: i64) -> Result<u64> {
        ...
        let sql = format!("UPDATE http_client_logs SET {} = {} + {} {}", col.as_sql(), col.as_sql(), amount, where_clause);
    ...
    pub async fn pluck_pair<K, V>(self, extract: impl Fn(&HttpClientLogView) -> (K, V)) -> Result<std::collections::HashMap<K, V>>
    where
        K: Eq + std::hash::Hash,
    {
...
impl<'db> HttpClientLogInsert<'db> {
    ...
    async fn save_with_db<'tx>(self, db: DbConn<'tx>) -> Result<HttpClientLogView> {
        ...
        let mut sql = format!("INSERT INTO {} ({}) VALUES ({})", "http_client_logs", col_sql.join(", "), placeholders.join(", "));
...
impl<'db> HttpClientLogUpdate<'db> {
    ...
    pub fn set_request_method(mut self, val: String) -> Self {
        self.sets.push((HttpClientLogCol::RequestMethod , val.into()));
        self
    }
    pub fn set_response_status(mut self, val: i32) -> Self {
        self.sets.push((HttpClientLogCol::ResponseStatus , val.into()));
        self
    }
    pub fn set_duration_ms(mut self, val: i32) -> Self {
    ...
    pub fn set_request_headers(mut self, val: serde_json::Value) -> Self {
        self.sets.push((HttpClientLogCol::RequestHeaders , val.into()));
        self
    }
    pub fn set_request_body(mut self, val: Option<String>) -> Self {
    ...
    pub fn set_response_headers(mut self, val: serde_json::Value) -> Self {
        self.sets.push((HttpClientLogCol::ResponseHeaders , val.into()));
        self
    }
    pub fn set_response_body(mut self, val: Option<String>) -> Self {
...
impl GeneratedTableAdapter for HttpClientLogTableAdapter {
    ...
    fn sortable_columns(&self) -> &'static [&'static str] { &["id", "request_url", "request_method", "response_status", "duration_ms", "request_body", "response_body", "created_at"] }
    ...
    fn column_descriptors(&self) -> &'static [DataTableColumnDescriptor] {
        &[
            ...
            DataTableColumnDescriptor { name: "response_status", label: "Response Status", data_type: "i32", sortable: true, localized: false, filter_ops: &["eq", "gte", "lte"] },
            DataTableColumnDescriptor { name: "duration_ms", label: "Duration Ms", data_type: "i32", sortable: true, localized: false, filter_ops: &["eq", "gte", "lte"] },
            DataTableColumnDescriptor { name: "request_headers", label: "Request Headers", data_type: "serde_json::Value", sortable: false, localized: false, filter_ops: &["eq", "gte", "lte"] },
            ...
            DataTableColumnDescriptor { name: "response_headers", label: "Response Headers", data_type: "serde_json::Value", sortable: false, localized: false, filter_ops: &["eq", "gte", "lte"] },
    ...
    fn fetch_page<'db>(&self, query: HttpClientLogQuery<'db>, page: i64, per_page: i64) -> BoxFuture<'db, anyhow::Result<Vec<HttpClientLogView>>> where Self: 'db {
...
pub trait HttpClientLogDataTableHooks: Send + Sync + 'static {
    ...
    fn map_row(&self, _row: &mut HttpClientLogView, _input: &DataTableInput, _ctx: &DataTableContext) -> anyhow::Result<()> { Ok(()) }
    fn default_row_to_record(&self, row: HttpClientLogView) -> anyhow::Result<serde_json::Map<String, serde_json::Value>> {
    ...
    fn row_to_record(&self, row: HttpClientLogView, _input: &DataTableInput, _ctx: &DataTableContext) -> anyhow::Result<serde_json::Map<String, serde_json::Value>> {
...
impl<H: HttpClientLogDataTableHooks> AutoDataTable for HttpClientLogDataTable<H> {
    ...
    fn map_row(&self, row: &mut HttpClientLogView, input: &DataTableInput, ctx: &DataTableContext) -> anyhow::Result<()> { self.hooks.map_row(row, input, ctx) }
    fn row_to_record(&self, row: HttpClientLogView, input: &DataTableInput, ctx: &DataTableContext) -> anyhow::Result<serde_json::Map<String, serde_json::Value>> { self.hooks.row_to_record(row, input, ctx) }
...
impl ActiveRecord for HttpClientLogView {
    ...
    async fn find(db: &sqlx::PgPool, id: Self::Id) -> anyhow::Result<Option<Self>> {
        HttpClientLog::new(db, None).find(id).await.map_err(|e| e.into())
    }
}
