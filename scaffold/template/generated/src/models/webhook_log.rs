...
impl WebhookLogView {
    pub fn update<'db>(&self, db: impl Into<DbConn<'db>>) -> WebhookLogUpdate<'db> {
        WebhookLog::new(db.into(), None).update().where_id(Op::Eq, self.id)
    }
...
impl WebhookLogCol {
    pub const fn all() -> &'static [WebhookLogCol] {
        &[WebhookLogCol::Id, WebhookLogCol::RequestUrl, WebhookLogCol::RequestMethod, WebhookLogCol::ResponseStatus, WebhookLogCol::DurationMs, WebhookLogCol::RequestHeaders, WebhookLogCol::RequestBody, WebhookLogCol::ResponseBody, WebhookLogCol::CreatedAt]
    }
