...
core_web::authz::ensure_permissions(
    ...
    &[Permission::ContentPageManage],
                ...
                <p>
                    For app-facing helpers, add typed permission methods in <code>app/models/admin.rs</code> via <code>#[rf_record_impl]</code> so workflows can call <code>auth.user.has_permission(...)</code> instead of scattering matcher details.
                </p>
